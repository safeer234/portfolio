...
function App() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.2 } // Detects section when 60% visible
    );
        ...
        <section id="home" className="max-w-6xl mx-auto px-4 py-10 lg:py-20">
          <div className="flex flex-col lg:flex-row items-center lg:items-center gap-10 lg:gap-16">
            ...
            <div className="flex-1">
              <h1 className="text-sm lg:text-2xl text-gray-300">
                Hello, I'm
              </h1>
              ...
              <div className="flex gap-3 mt-6">
                <a
                  href="https://github.com/safeer234"
                  target="_blank"
                  rel="noreferrer"
                  className=" w-10 h-10 rounded-full overflow-hidden hover:-translate-y-1 transition"
                >
                  <svg
                    className="w-full h-full bg-[#34d399]"
                ...
                <a
                  href="https://www.linkedin.com/in/safeermohammedk"
                  target="_blank"
                  rel="noreferrer"
                  className=" w-10 h-10 rounded-full overflow-hidden hover:-translate-y-1 transition"
                >
            ...
            {/* Image + spinner (overlap only on lg) */}
    ...
    />
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="mt-6 text-sm lg:text-base text-gray-200 max-w-xl">
                Motivated Frontend Developer skilled in creating responsive and
                user-friendly web interfaces using React.js, JavaScript, HTML5,
                CSS3, and Tailwind CSS. Passionate about crafting engaging
                digital experiences, integrating APIs, and following clean
                coding practices. Eager to contribute to innovative web projects
        ...
        <section
          id="projects"
          className="max-w-6xl mx-auto px-4 lg:mt-75 py-10 lg:py-20"
        >
          <div className="text-center">
