...
function App() {
  ...
  return (
    <>
     <header>
      <nav className='block sm:block md:block lg:flex gap-180 py-5 px-14 text-xl font-semibold text-[white]'>
        <div>
          <a href="#home">Safeer.</a>
          </div>
        <div className='block sm:block md:block lg:flex gap-15'>
         <a href="#home">Home</a>
     ...
     <section id='home'>
      <div className='flex sm:flex md:flex lg:flex'>
        <div className='text-[white]  mt-35 ml-50 text-7xl'>
          <h1><span className='text-[30px]'>Hello i'm</span><br /><span className='text-[#34d399]'>Safeer <br /> Mohammed K </span> </h1>
          <p className='text-[30px] mt-2'>And <span className='animate-ping'>i'm a Front-End Developer</span></p>
          

        </div>

        <div className='mt-40 ml-262 absolute z-1 border border-orange rounded-[210px] '>
          
            <img className='w-64 h-65 border  rounded-[210px]' src={profileimg1} alt="" />
        ...
        <div className='z-5 w-65 h-65 mt-40 rounded-[410px] ml-99
      ...
      <p className=' ml-50 mt-2 text-[18px] text-[white]'>Aspiring Frontend Developer skilled in creating responsive and user-friendly web interfaces <br />using React.js, JavaScript, HTML5, CSS3, and Tailwind CSS.</p>
      <div className='flex gap-4 ml-50 mt-8'>
      ...
      <div className=' flex ml-50 mt-10 gap-3'>
     ...
     <section id='about'>
        ...
        <div className=' ml-65  '>
          <div className=' flex w-76 h-76 bg-[#ecfdf5] z-1 mt-30 rounded-[410px] overflow-hidden items-center justify-center duration-300 ease-in hover:bg-[#34d399]   hover:translate-y-1.5 hover:scale-x-110 hover:scale-y-110   '>
             <img className='  w-74 h-74 mb-0 rounded-[410px]'src= {profileimg1} alt="" />
          </div>
        ...
        <div className=' text-center mr-30'>
          <div className='mt-2 text-center'>
             <h1 className='text-[#34d399]  ml-80 text-6xl  '>About Me</h1>

          </div>
          
           <br />
            <div className=' underline ml-140 border-2 border-[#34d399] w-12 '></div>

          
          
<div className='flex justify-center items-center text-center'>
 <p className='ml-50 mt-2 text-[18px] text-[white]'>Motivated Frontend Developer skilled in creating responsive and user-friendly web interfaces using React.js, JavaScript, HTML5, CSS3, and Tailwind CSS. Passionate about crafting engaging digital experiences, integrating APIs, and following clean coding practices. Eager to contribute to innovative web projects in a collaborative, growth-focused environment.</p>
</div>
     ...
     <section id='skills'>
      <div className='text-center mt-100'>
           ...
           <p className='text-[#34d399] text-6xl'>Skills</p>
           <div className=' underline mt-2 ml-183 border-2 border-[#34d399] w-12 '></div>
      ...
      <div className='flex items-center justify-center'>
        <div className=' mt-10  grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 p-6 '>

        {skills.map((skill, index) => {
          return(
            <div className='w-45 flex h-20 text-center duration-300 ease-in items-center justify-center p-3 px-2 hover:translate-y-1.5 hover:scale-x-110 hover:scale-y-110  text-2xl text-[#34d399] font-medium rounded-2xl   bg-[#09090b] border-2 hover:border-2 border-[#34d399] hover:bg-[#34d399] hover:text-[black] '>
     ...
     <div className='text-center mt-85'>
        <p className='text-[#34d399]  text-6xl'>Projects</p>
        <br />
            <div className=' underline ml-183 border-2 border-[#34d399] w-12 '></div>
      </div>

      <div className='flex justify-center gap-4'>
        <div className=' mt-10  grid grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-10 p-6 '>

        {projects.map((project, index) => {
          return(
            <div className=' flex w-70  h-80   justify-center p-3 px-2   text-2xl text-[#34d399] font-medium rounded-2xl border-[white]  border-3 bg-[#09090b]   duration-300 ease-in hover:border-3 hover:border-[#34d399] '>
