...
function App() {
  ...
  return (
    <>
     <header>
      <nav className='flex fixed  gap-27 lg:gap-180 py-5 px-3 lg:px-14 text-xl font-semibold text-[white]'>
        <div>
     ...
     <section id='home'>
      <div className='block lg:flex'>
        <div className='text-[white] px-5 py-38 lg:py-0 lg:px-0  lg:mt-42 lg:ml-50 lg:text-7xl'>
          <h1><span className=' text-sm lg:text-[30px]'>Hello i'm</span><br /><span className='text-[#34d399] text-2xl  lg:text-7xl'>Safeer <br /> Mohammed K </span> </h1>
          <p className='lg:text-[30px]  text-sm lg:mt-2'>And <span className='animate-ping'>i'm a Front-End Developer</span></p>
        ...
        <div className='  lg:mt-40 lg:ml-262 absolute z-1  '>
            ...
            <img className=' w-36 ml-10 h-36 mt-1 lg:mt-0  lg:ml-0 lg:w-64 lg:h-65 border  rounded-[410px]' src={profileimg1} alt="" />
        ...
        <div className='z-5 w-38 h-38 ml-9  lg:w-65 lg:h-65 lg:mt-40 rounded-[410px] lg:ml-99
      ...
      <p className=' lg:ml-50  px-5 lg:px-0 py-23 lg:py-5 lg:mt-2 text-sm w-60  lg:w-200 lg:text-[18px] text-[white]'>Aspiring Frontend Developer skilled in creating responsive and user-friendly web interfaces <br />using React.js, JavaScript, HTML5, CSS3, and Tailwind CSS.</p>
      <div className='flex gap-4 px-0 lg:px-0 lg:ml-50 '>
      ...
      <div className='ml-7 lg:flex  lg:px-0 lg:ml-50 mt-10 gap-4 lg:gap-1.5'>
        <button  className=' border-2 border-[#34d399] duration-300 ease-out font-semibold text-[#34d399] hover:bg-[#34d399]  hover:text-[black] rounded-3xl lg:w-30 lg:h-10 w-39 h-10 text-center justify-center items-center mb-3 lg:mb-0'>Download CV</button><br />
     ...
     <section id='about'>
        ...
        <div className=' lg:ml-65 px-6 lg:px-0 z-1 lg:z-0 absolute lg:relative lg:py-0  '>
          <div className=' flex w-42 h-42 lg:w-76 lg:h-76 bg-[#ecfdf5] z-1 mt-30 rounded-[410px] overflow-hidden items-center justify-center duration-300 ease-in hover:bg-[#34d399]   hover:translate-y-1.5 hover:scale-x-110 hover:scale-y-110   '>
             <img className=' w-40 h-40 lg:w-74 lg:h-74 mb-0 rounded-[410px]'src= {profileimg1} alt="" />
          </div>
        ...
        <div className=' text-center lg:mr-30'>
          <div className='mt-2 text-center pr-37 lg:pr-0'>
             <h1 className='text-[#34d399]   lg:ml-50 text-2xl lg:text-6xl  '>About Me</h1>
             <div className=' underline ml-24 lg:ml-136 mt-2 border-2 border-[#34d399] w-8 lg:w-12 '></div>
...
<div className='lg:flex lg:justify-center lg:items-center lg:text-center'>
 <p className='lg:ml-50 w-52 lg:w-170 px-5  py-80 lg:px-0 lg:py-0 lg:mt-2 text-sm lg:text-[18px] text-[white]'>Motivated Frontend Developer skilled in creating responsive and user-friendly web interfaces using React.js, JavaScript, HTML5, CSS3, and Tailwind CSS. Passionate about crafting engaging digital experiences, integrating APIs, and following clean coding practices. Eager to contribute to innovative web projects in a collaborative, growth-focused environment.</p>
</div>
     ...
     <section id='skills'>
      <div className='lg:text-center lg:mt-100'>
           ...
           <p className='text-[#34d399] px-22 lg:px-0 text-2xl lg:text-6xl'>Skills</p>
           <div className=' underline mt-2 ml-26 lg:ml-183 border-2 border-[#34d399]  w-6 lg:w-12 '></div>
      ...
      <div className='lg:flex  lg:items-center lg:justify-center'>
        <div className=' mt-10 px-8  lg:px-0 lg:mr-0 lg:grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-17 lg:gap-6 lg:p-6 '>
     ...
     <div className='lg:text-center mt-85'>
        <p className='text-[#34d399] px-15 lg:px-0 text-2xl lg:text-6xl'>Projects</p>
        
            <div className=' underline ml-22 mt-2 lg:mt-3  lg:ml-183 border-2 border-[#34d399] w-8 lg:w-12 '></div>
      </div>

      <div className='flex justify-center gap-4'>
        <div className=' mt-10 pr-45 lg:pr-0  lg:ml-0  lg:grid grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-10 p-6 '>

        {projects.map((project, index) => {
          return(
            <div className=' mb-10 lg:mb-0 flex lg:w-70 w-40 h- lg:h-80   justify-center p-3 px-2   text-2xl text-[#34d399] font-medium rounded-2xl border-[white]  border-3 bg-[#09090b]   duration-300 ease-in hover:border-3 hover:border-[#34d399] '>
